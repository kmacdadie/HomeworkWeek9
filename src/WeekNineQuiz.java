...
public class WeekNineQuiz {
	...
	public class Quiz {
		 ...
		 *  SELECT t.title, e.last_name FROM employees e
		 ...
		 *  
		 *  SELECT  t.title, s.salary, e.first_name FROM employees e
		 ...
		 * 
		 *	Select d.dept_name as "Department", max(s.salary) as "Max Salary" from departments d
